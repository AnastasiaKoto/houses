...
<div class="contacts-form" data-move-target=".contacts-map__frame" data-move-break="992">
	<? if ($arResult["isFormNote"] == "Y") {
		...
		<div class="thx-inner">
			...
			<? endif; ?>
			<a href="javascript:void(0)" onclick="window.location.reload();" class="question-form__form-close ask-btn">
				Закрыть
			</a>
		</div>
		<script>
	...
	<? } elseif ($arResult["isFormNote"] != "Y") { ?>
		...
		<button type="submit" class="arrow-btn__dark modal-submit" name="web_form_submit"
