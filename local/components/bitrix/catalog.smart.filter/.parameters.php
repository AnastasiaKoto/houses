...
$arComponentParameters = array(
	...
	"PARAMETERS" => array(
		...
		"SPECIAL_SECTION_ID" => array(
			"PARENT" => "DATA_SOURCE",
			"NAME" => "ID раздела вариативных домов (для кастомной фильтрации)",
			"TYPE" => "STRING",
			"DEFAULT" => "10",
		),
		"LINKED_IBLOCK_ID" => array(
			"PARENT" => "DATA_SOURCE", 
			"NAME" => "ID инфоблока предложений",
			"TYPE" => "STRING",
			"DEFAULT" => "11",
		),
		"LINK_PROPERTY_CODE" => array(
			"PARENT" => "DATA_SOURCE",
			"NAME" => "Код свойства привязки к элементам",
			"TYPE" => "STRING",
			"DEFAULT" => "HOUSE_VARIABLES",
		),
